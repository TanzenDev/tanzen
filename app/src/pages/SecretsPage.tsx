        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 z-50">
          <div className="rounded-lg border dark:border-slate-700 border-slate-200 dark:bg-slate-800 bg-white p-6 w-full max-w-sm">
            ...
            <p className="text-sm dark:text-slate-400 text-slate-600 mb-4">
              Delete <span className="font-mono dark:text-white text-slate-900">{deleteTarget}</span>? This cannot be undone.
            </p>
      ...
      {creating && (
        <div className="rounded-lg border dark:border-slate-700 border-slate-200 dark:bg-slate-800 bg-white p-6">
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium dark:text-slate-300 text-slate-700 mb-1">Value</label>
              <input
                type="password"
